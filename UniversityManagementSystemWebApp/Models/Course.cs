...
namespace UniversityManagementSystemWebApp.Models
{
    public class Course
    {
        ...
        [StringLength(int.MaxValue, MinimumLength = 5, ErrorMessage = "Code must be at least 5 characters long.")]
        public string CourseCode { get; set; }
        [Required]
        [Range(0.5, 5.0, ErrorMessage = "Credit Must be between 0.5 to 5.0")]
        [RegularExpression(@"^[0-9]+(\.[0-9]{0,1})?$", ErrorMessage = "Type A Valid Number")]
        ...
        [Required(ErrorMessage = "Please Provide Semester")]
